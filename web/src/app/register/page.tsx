...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.message || "Registration failed. Please try again with another email.");
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="max-w-md w-full space-y-8 bg-white/80 backdrop-blur-xl p-8 sm:p-10 rounded-3xl border border-slate-200/80 shadow-xl shadow-slate-900/5">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-slate-500">
            Join Explore Sri Lanka to bookmark your dream destinations and share honest reviews.
          </p>
        </div>
